...
const Wishes = ({ wishes }) => (_jsx(motion.div, { initial: { opacity: 0, y: 40 }, animate: { opacity: 1, y: 0 }, transition: { delay: 0.6, duration: 0.8, ease: "easeOut" }, style: {
    ...
    }, children: wishes.map((wish, i) => (_jsx(motion.p // Changed to p for paragraphs of wishes
    , { whileHover: {
            scale: 1.01,
